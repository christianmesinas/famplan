...
Revision ID: 858be259f4e2
Revises: 
Create Date: 2025-04-17 14:47:56.132292
...
def upgrade():
    ...
    sa.Column('client_secret', sa.String(length=200), nullable=False),
    ...
    with op.batch_alter_table('calendar_credentials', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_calendar_credentials_user_id'), ['user_id'], unique=False)
